  ...
  return (
    <div className="h-dvh overflow-hidden overflow-x-clip">
      <div className="pointer-events-none fixed inset-0 opacity-90">
        <div className="absolute -left-32 -top-40 h-72 w-72 rounded-full bg-accent/12 blur-3xl" />
        <div className="absolute -right-24 top-40 h-80 w-80 rounded-full bg-accent2/10 blur-3xl" />
        <div className="absolute -bottom-32 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-white/3 blur-3xl" />
      </div>
